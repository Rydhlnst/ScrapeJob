    ...
    <div className="space-y-6">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setDraft((current) => ({
                      ...
                      hero: {
                        ...current.hero,
                        quickLinks: setLinkValue(
                          current.hero.quickLinks,
                          index,
                          "label",
                          event.target.value,
                        ),
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          <Field label="Title">
            <Textarea
              value={draft.featuredJobs.title}
              onChange={(event) =>
                setDraft((current) => ({
                  ...current,
                  featuredJobs: { ...current.featuredJobs, title: event.target.value },
                }))
              }
            />
          </Field>
          <Field label="Description">
            <Textarea
              value={draft.featuredJobs.description}
              onChange={(event) =>
                setDraft((current) => ({
                  ...current,
                  featuredJobs: { ...current.featuredJobs, description: event.target.value },
                }))
              }
            />
          </Field>
          <Field label="Empty state">
            <Textarea
              value={draft.featuredJobs.emptyState}
              onChange={(event) =>
                setDraft((current) => ({
                  ...current,
                  featuredJobs: { ...current.featuredJobs, emptyState: event.target.value },
                }))
              }
            />
          </Field>
          <div className="grid gap-4 md:grid-cols-2">
            <Field label="Sort">
              <Input
                value={draft.featuredJobs.rules.sort}
                onChange={(event) =>
                  setDraft((current) => ({
                    ...current,
                    featuredJobs: {
                      ...current.featuredJobs,
                      rules: {
                        ...current.featuredJobs.rules,
                        sort: event.target.value as LandingPageContent["featuredJobs"]["rules"]["sort"],
                      },
                    },
                  }))
                }
            ...
            <Field label="Limit">
              <Input
                type="number"
                value={draft.featuredJobs.rules.limit}
                onChange={(event) =>
                  setDraft((current) => ({
                    ...current,
                    featuredJobs: {
            ...
            <Field label="Category filter">
              <Input
                value={draft.featuredJobs.rules.category ?? ""}
                onChange={(event) =>
                  setDraft((current) => ({
                    ...current,
                    featuredJobs: {
            ...
            <Field label="Source filter">
              <Input
                value={draft.featuredJobs.rules.source ?? ""}
                onChange={(event) =>
                  setDraft((current) => ({
                    ...current,
                    featuredJobs: {
        ...
        <Field label="Section title">
          <Input
            ...
            onChange={(event) =>
              setDraft((current) => ({
                ...current,
                benefits: { ...current.benefits, title: event.target.value },
              }))
            }
          />
        </Field>
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setDraft((current) => ({
                      ...
                      benefits: {
                        ...current.benefits,
                        items: setBenefitValue(current.benefits.items, index, "title", event.target.value),
                      },
                    }))
                  }
                />
      ...
      >
        <Field label="Section title">
          <Input
            value={draft.trustedCompanies.title}
            onChange={(event) =>
              setDraft((current) => ({
                ...current,
                trustedCompanies: { ...current.trustedCompanies, title: event.target.value },
              }))
            }
          />
        </Field>
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setDraft((current) => ({
                      ...current,
                      trustedCompanies: {
                        ...current.trustedCompanies,
                        items: setCompanyValue(current.trustedCompanies.items, index, "id", event.target.value),
                      },
                    }))
                  }
                />
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setDraft((current) => ({
                      ...
                      trustedCompanies: {
                        ...current.trustedCompanies,
                        items: setCompanyValue(current.trustedCompanies.items, index, "name", event.target.value),
                      },
                    }))
                  }
                />
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setDraft((current) => ({
                      ...
                      trustedCompanies: {
                        ...current.trustedCompanies,
                        items: setCompanyValue(current.trustedCompanies.items, index, "url", event.target.value),
                      },
                    }))
                  }
                />
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setDraft((current) => ({
                      ...
                      trustedCompanies: {
                        ...current.trustedCompanies,
                        items: setCompanyValue(
                          current.trustedCompanies.items,
                          index,
                          "brandColor",
                          event.target.value,
                        ),
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Field label="Primary button label">
            <Input
              value={draft.cta.primaryButton.label}
              onChange={(event) =>
                setDraft((current) => ({
                  ...current,
                  cta: {
                    ...current.cta,
                    primaryButton: { ...current.cta.primaryButton, label: event.target.value },
                  },
                }))
              }
            />
          ...
          <Field label="Primary button link">
            <Input
              value={draft.cta.primaryButton.href}
              onChange={(event) =>
                setDraft((current) => ({
                  ...current,
                  cta: {
                    ...current.cta,
                    primaryButton: { ...current.cta.primaryButton, href: event.target.value },
                  },
                }))
              }
            />
          ...
          <Field label="Secondary button label">
            <Input
              value={draft.cta.secondaryButton.label}
              onChange={(event) =>
                setDraft((current) => ({
                  ...current,
                  cta: {
                    ...current.cta,
                    secondaryButton: { ...current.cta.secondaryButton, label: event.target.value },
                  },
                }))
              }
            />
          ...
          <Field label="Secondary button link">
            <Input
              value={draft.cta.secondaryButton.href}
              onChange={(event) =>
                setDraft((current) => ({
                  ...current,
                  cta: {
                    ...current.cta,
                    secondaryButton: { ...current.cta.secondaryButton, href: event.target.value },
                  },
                }))
              }
            />
