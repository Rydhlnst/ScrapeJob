      ...
      groups: [
        {
          ...
          children: [
            ...
            { label: "SEO", href: "/admin/content?tab=seo" },
          ],
        },
      ],
    },
      ...
      groups: [
        {
          ...
          icon: Newspaper,
          children: [
            { label: "Semua Artikel", href: "/admin/blog" },
            { label: "Published", href: "/admin/blog?status=published" },
            { label: "Draft", href: "/admin/blog?status=draft" },
          ],
        },
      ],
    },
