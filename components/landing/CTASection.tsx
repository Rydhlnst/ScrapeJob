      ...
      <Container>
        <div className="grid items-center gap-14 lg:grid-cols-[.88fr_1.12fr] lg:gap-20">
          <Reveal className="min-w-0">
            ...
            <Link href={content.primaryButton.href} className="inline-flex h-12 items-center gap-2 rounded-xl bg-[#f2a23a] px-6 text-sm font-extrabold text-[#171717] shadow-[0_4px_0_rgba(0,0,0,.22)] transition-all hover:-translate-y-0.5 hover:bg-[#df8d27]">{content.primaryButton.label}<ArrowRight className="size-4" /></Link>
