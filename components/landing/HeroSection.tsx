  ...
  return (
    <section className="w-full overflow-hidden bg-white pt-0">
      ...
      <div className="w-full border-b border-black/10 bg-white">
        <SiteContent className="flex flex-wrap items-center justify-center gap-x-12 gap-y-4 py-8 text-xl font-extrabold tracking-[-.06em] text-[#171717] sm:justify-between">
